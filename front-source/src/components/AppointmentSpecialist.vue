<template>
  <div class="wrapp">
    <div class="img">
      <img v-lazy="selecteSpecialist.user_image || photo" alt="photo">
    </div>
    <div class="confirmation">
      <h2>Uw afspraak met <span>{{ selecteSpecialist.firstname }} {{ selecteSpecialist.lastname }}</span> is bevestigd!</h2>
